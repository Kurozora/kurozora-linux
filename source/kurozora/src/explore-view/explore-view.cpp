...
namespace kurozora
{
    ExploreView::ExploreView(std::shared_ptr<Gtk::Window> parent_window)
    {
        ...
        for (int i = 0; i < 10; ++i)
        {
            featured_shows_previews.push_back(std::shared_ptr<ShowPreview>(new ShowPreview("Oshi No Ko", "The best anime ever!", "https://cdn.kurozora.app/179317/3e9c35f0-bc3e-4144-992a-ecd70cfbde72.jpg?v=1685810356")));
        }
